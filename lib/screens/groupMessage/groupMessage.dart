                                                            ...
                                                            builder:
                                                              ...
                                                              return EmojiPicker(
                                                                onEmojiSelected:
                                                                  ...
                                                                  await _apiSerive.groupMessageReaction(emoji: emojiCounts![
                                                                            index]
                                                                        .emoji!, msgId: emojiCounts![
                                                                        index]
                                                                    .groupmsgid!, sChannelId: widget
                                                                    .channelID);
                                ...
                                child: IconButton(
                                    onPressed: () {
                                      ...
                                      for (var i = 0;
                                          ...
                                          i++) {
                                        if (plaintext
                                            .contains(uniqueList[i]["name"])) {
                                          currentMentions
                                              .add("@${uniqueList[i]["name"]}");
                                        }
                                      }

                  ...
                  children: [
                    Expanded(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        String? profileImage =
                            tGroupMessages![index].profileName;
                                                          ...
                                                          onPressed: () async {
                                                            if (_selectedMessageIndex !=
                                                              ...
                                                              if (isStared) {
                                                                ...
                                                                await _apiSerive.getMessageStar(
                                                                    tGroupMessages![
                                                                            index]
                                                                        .id!,
                                                                    widget
                                                                ...
                                                                builder:
                                                                  ...
                                                                  return EmojiPicker(
                                                                    onEmojiSelected:
                                                                      ...
                                                                      setState(
                                                                          () {
                                                                        groupMessageID = tGroupMessages![index]
                                                                            .id!
                                                                            .toInt();
                                                                        selectedEmoji =
                                                                            emoji.emoji;
                                                            ...
                                                            return Container(
                                                              ...
                                                              child: TextButton(
                                                                onPressed:
                                                                  ...
                                                                  HapticFeedback
                                                                      .vibrate();
                                                                  _apiSerive.groupMessageReaction(
                                                                      emoji: emojiCounts![
                                                                              index]
                                                                          .emoji!,
                                                                      msgId: emojiCounts![
                                  ...
                                  Container(
                                    ...
                                    child: IconButton(
                                        onPressed: () {
                                          ...
                                          sendGroupMessageData(htmlContent,
                                              channelId, mentionnames);
                                        },
                                        icon: const Icon(
                                          Icons.send,
                                          color: Colors.white,

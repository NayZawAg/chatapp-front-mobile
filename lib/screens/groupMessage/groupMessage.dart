                      ...
                      if (snapshot.hasError || !snapshot.hasData) {
                        ...
                        return ListView.builder(
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            ...
                            int? count = groupMessageList.retrieveGroupMessage!
                                .tGroupMessages![index].count;
                            ...
                            int currentUser = SessionStore
                                ...
                                .toInt();
                            int sendUserId = groupMessageList
                                .retrieveGroupMessage!
                                .tGroupMessages![index]
                                .sendUserId!
                                .toInt();
                            ...
                            List<String> initials = gp_name
                                .split(" ")
                                .map((e) => e.substring(0, 1))
                                .toList();
                            String groupName = initials.join("");
                            String time = groupMessageList.retrieveGroupMessage!
                                .tGroupMessages![index].createdAt
                                .toString();

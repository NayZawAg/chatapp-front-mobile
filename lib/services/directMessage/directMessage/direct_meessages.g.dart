  ...
  Future<DirectMessages> getAllDirectMessages(
    ...
    final _result = await _dio
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              'https://cmmteam3-backend-api.onrender.com/m_users/${userId}',
  ...
  Future<void> sendMessage(
    ...
    await _dio.fetch<void>(_setStreamType<void>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'https://cmmteam3-backend-api.onrender.com/directmsg',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<void> directStarMsg(
    ...
    await _dio.fetch<void>(_setStreamType<void>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'https://cmmteam3-backend-api.onrender.com/star',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<void> directUnStarMsg(
    ...
    await _dio.fetch<void>(_setStreamType<void>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'https://cmmteam3-backend-api.onrender.com/unstar',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<void> deleteMessage(
    ...
    await _dio.fetch<void>(_setStreamType<void>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'https://cmmteam3-backend-api.onrender.com/delete_directmsg',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(

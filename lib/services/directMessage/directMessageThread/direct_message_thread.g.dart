  ...
  Future<DirectMessageThread> getAllThread(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              'https://cmmteam3-backend-api.onrender.com/directhread/${directMsgid}',
  ...
  Future<String> sentThread(
    ...
    final _result = await _dio.fetch<String>(_setStreamType<String>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'https://cmmteam3-backend-api.onrender.com/directthreadmsg',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<void> starThread(
    ...
    await _dio.fetch<void>(_setStreamType<void>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'https://cmmteam3-backend-api.onrender.com/starthread',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<void> unStarThread(
    ...
    await _dio.fetch<void>(_setStreamType<void>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'https://cmmteam3-backend-api.onrender.com/unstarthread',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<void> deleteThread(
    ...
    await _dio.fetch<void>(_setStreamType<void>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'https://cmmteam3-backend-api.onrender.com/delete_directthread',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
